...
for (const token of existingTokenList.tokens) {
    if (token.chainId === 59144) {
        uniqueTokenAddresses.add((_a = token.extension) === null || _a === void 0 ? void 0 : _a.rootAddress.toLowerCase());
    }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        for (const event of events) {
            try {
                ...
                let tokenContract = new ethers_1.ethers.Contract(tokenAddress, erc20ContractABI, provider);
                let tokenInfo;
                try {
                    tokenInfo = yield fetchTokenInfo(tokenContract, tokenAddress);
                }
                catch (error) {
                    ...
                    try {
                        tokenInfo = yield fetchTokenInfo(tokenContractAlt, tokenAddress, true);
                    }
                    catch (error) {
...
function updateTokenList(tokenInfoArray) {
    ...
    try {
        ...
        for (const token of existingTokenList.tokens) {
            if (token.chainId === 59144) {
                existingTokenAddresses.add((_a = token.extension) === null || _a === void 0 ? void 0 : _a.rootAddress.toLowerCase());
            }
            else if (token.chainId === 1) {
        ...
        const newTokens = tokenInfoArray.filter((info) => {
            var _a, _b;
            const addressLowerCase = (_b = (_a = info.extension) === null || _a === void 0 ? void 0 : _a.rootAddress) === null || _b === void 0 ? void 0 : _b.toLowerCase();
